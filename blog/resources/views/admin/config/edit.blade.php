...
<div class="result_wrap">
    <form action="{{url('admin/config/'.$field->config_id)}}" method="post">
        {{method_field('PUT')}}
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="config_title" value="{{$field->config_title}}">
            ...
            <tr>
                <th>配置项名称：</th>
                <td>
                    <input type="text" class="lg" name="config_name"  value="{{$field->config_name}}">
                    <p>配置项名称可以写30个字</p>
                </td>
            </tr>
            ...
            <tr class="field_value">
                ...
                <td>
                    ...
                    <p><i class="fa fa-exclamation-circle yellow"></i>类型值只有在ratio条件下才需要配置，格式1|开始，0|关闭</p>
                </td>
            </tr>
            ...
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" class="sm" name="config_order" value="{{$field->config_order}}">
                </td>
            </tr>
            ...
            <tr>
                <th>说明：</th>
                <td>
                    <textarea  id="" cols="30"  rows="10" name="config_tips">{{$field->config_tips}}</textarea>
                </td>
            </tr>
