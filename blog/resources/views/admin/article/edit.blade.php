...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a>  &raquo; 文章编辑
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <div class="short_wrap">
            <a href="{{url('admin/article/edit')}}"><i class="fa fa-plus"></i>编辑文章</a>
    ...
    <form action="{{url('admin/article/'.$field->art_id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>关键词：</th>
                <td>
                    <input type="text" class="lg" name="art_tag" {{$field->art_tag}}>
                </td>
            </tr>
